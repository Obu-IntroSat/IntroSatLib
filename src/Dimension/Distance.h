...
public:
	explicit Distance(int64_t value): _value(value * 1000000) {};
	explicit Distance(float value): _value(value * 1000000) {};
	...
	friend inline const Distance operator+ (const Distance& a, const Distance& b);
	friend inline const Distance operator- (const Distance& a, const Distance& b);
