...
public:
	Multiply<T11, T12>(float value) :
			_value(value)
	{
	}
	;
	Multiply<T11, T12>(const Multiply<T12, T11> &value) :
			_value(value._value)
	{
	}
	;
	...
	friend inline const Multiply<T1, T2> operator*(const Multiply<T1, T2> &a,
			const float &b);
	template<typename T1, typename T2>
	friend inline const Multiply<T1, T2> operator*(const float &a,
			const Multiply<T1, T2> &b);
	...
	template<typename T1, typename T2>
	friend inline const Multiply<Multiply<T1, T2>, Multiply<T1, T2>> operator*(
			const Multiply<T1, T2> &a, const Multiply<T1, T2> &b);

	template<typename T1, typename T2>
	friend inline const float operator/(const Multiply<T1, T2> &a,
			const Multiply<T1, T2> &b);
};
...
template<typename T1, typename T2>
inline const float operator/(const Multiply<T1, T2> &a,
		const Multiply<T1, T2> &b)
{
