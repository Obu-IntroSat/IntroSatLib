...
ThreeDimensionalDevice<T, TRaw>::ThreeDimensionalDevice(
		...
		IntroSatLib::Base::Device(std::move(interface),
				id), _x(
				IntroSatLib::Filters::LinearFilter<
						IntroSatLib::Filters::ScalableFilterValue<TRaw>>(size),
				maxScale), _y(
				IntroSatLib::Filters::LinearFilter<
						IntroSatLib::Filters::ScalableFilterValue<TRaw>>(size),
				maxScale), _z(
...
ThreeDimensionalDevice<T, TRaw>::ThreeDimensionalDevice(
		...
		uint8_t size) :
		IntroSatLib::Base::Device(interface,
				id), _x(
				IntroSatLib::Filters::LinearFilter<
						IntroSatLib::Filters::ScalableFilterValue<TRaw>>(size),
				minScale, maxScale), _y(
				IntroSatLib::Filters::LinearFilter<
						IntroSatLib::Filters::ScalableFilterValue<TRaw>>(size),
				minScale, maxScale), _z(
				IntroSatLib::Filters::LinearFilter<
						IntroSatLib::Filters::ScalableFilterValue<TRaw>>(size),
				minScale, maxScale)
{
