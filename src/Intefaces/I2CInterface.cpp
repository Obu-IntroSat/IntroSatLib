...
namespace IntroSatLib
{
	namespace Interfaces
	{
		...
		{
			return StatusConverter::Convert(HAL_I2C_IsDeviceReady(_i2c, _address, 1, 1000));
		}

		Status I2CInterface::Read(uint8_t* Data, uint8_t Nbytes)
		{
			return StatusConverter::Convert(HAL_I2C_Master_Receive(_i2c, _address, Data, Nbytes, 1000));
		}

		Status I2CInterface::Read(uint8_t Register, uint8_t* Data, uint8_t Nbytes)
		{
			return StatusConverter::Convert(HAL_I2C_Mem_Read(_i2c, _address, Register, I2C_MEMADD_SIZE_8BIT, Data, Nbytes, 1000));
		}

		Status I2CInterface::Write(uint8_t* Data, uint8_t Nbytes)
		{
			return StatusConverter::Convert(HAL_I2C_Master_Transmit(_i2c, _address, Data, Nbytes, 1000));
		}
